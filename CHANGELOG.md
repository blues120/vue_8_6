...
- 提供重置登录信息状态方法。修复登出或替换账号还保留之前账号operator信息和痕迹bug
...
- 支持菜单管理operator动态(菜单)路由
- 移除api文件夹目录，简化api请求方式
- newelement-ui组件主题12套，可同步edit配置设置成整站主题
...
- new内容tabs标签页，关闭当前／其它／全部、刷新当前功能
- newscss变量皮肤定制
