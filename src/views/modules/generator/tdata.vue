  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('generator:tdata:save')" type="primary" @click="addOrUpdateHandle()">new</el-button>
        <el-button v-if="isAuth('generator:tdata:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">batch delete</el-button>
      </el-form-item>
    </el-form>
    <el-table
      :data="dataList"
...
<script>
  import AddOrUpdate from './tdata-add-or-update'
  export default {
    data () {
      return {
        dataForm: {
    ...
    methods: {
      ...
      getDataList () {
        ...
        this.$http({
          url: this.$http.adornUrl('/generator/tdata/list'),
          method: 'get',
      ...
      deleteHandle (id) {
        ...
        this.$confirm(`make sure对[id=${ids.join(',')}]进行[${id ? 'delete' : 'batch delete'}]operator?`, 'alert', {
          ...
          this.$http({
            url: this.$http.adornUrl('/generator/tdata/delete'),
            method: 'post',
