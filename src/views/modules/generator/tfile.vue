  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('generator:tfile:save')" type="primary" @click="addOrUpdateHandle()">new</el-button>
        <el-button v-if="isAuth('generator:tfile:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">batch delete</el-button>
      </el-form-item>
    </el-form>
    <el-table
      :data="dataList"
...
<script>
  import AddOrUpdate from './tfile-add-or-update'
  export default {
    data () {
      return {
        dataForm: {
